...
<ul>
<li>The input element of the igNumericEditor will render a <b>tabindex</b> attribute with a corresponding value from the <b>tabindex</b> option of the igNumericEditor, which allows access to the elements through the use of TAB and SHIFT+TAB keys. <br />
