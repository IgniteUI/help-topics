...
The following screenshot illustrates how the `igDataChart` control with the `thickness` property of the  `crosshairLayer` object looks configured using the following setting:
