...
The following screenshot demonstrates how the `igDataChart` control with the `targetSeries` property of the `itemToolTipLayer` object looks as a result of the following setting:
