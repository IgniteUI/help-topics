...
The following screenshot illustrates how the `igDataChart` control renders with the `categoryTooltipLayer` object’s `toolTipPosition` property configured with the following setting:
