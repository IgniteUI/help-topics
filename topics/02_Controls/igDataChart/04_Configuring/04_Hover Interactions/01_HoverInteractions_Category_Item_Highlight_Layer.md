...
The following screenshot illustrates how the `igDataChart` control with the `categoryItemHighlightLayer` object’s `bandhighlightType` and `brush` properties looks as a result of the following setting:
