...
## <a id="ddInteraction"></a> igDateEditor with dropdown

In this section you can see what key combinations can be used when you have a date editor with dropdown.
