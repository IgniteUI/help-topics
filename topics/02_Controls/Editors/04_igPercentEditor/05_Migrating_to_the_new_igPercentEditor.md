...
symbol|Used to set the percent symbol, which is used in display (no focus) state.|This option is renamed to `percentSymbol` to better communicate what it does.
