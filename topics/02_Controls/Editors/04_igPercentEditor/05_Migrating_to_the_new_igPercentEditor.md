...
getSelectedText|Used to get selected text in editor.|This method is removed as it doesn't make sense to have such a method in percent editor.
...
[See all API methods](%%jQueryApiUrl%%/ui.igpercenteditor#methods)
