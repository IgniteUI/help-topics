...
Modernizr 3.x support | Ignite UI uses Modernizr library to detect touch environments (see [Touch Support for Ignite UI Controls](Touch_Support_for_NetAdvantage_for_jQuery_Controls.html)). [Mordernizr 3.x](https://modernizr.com/) is now supported along with older Modernizr versions. |
