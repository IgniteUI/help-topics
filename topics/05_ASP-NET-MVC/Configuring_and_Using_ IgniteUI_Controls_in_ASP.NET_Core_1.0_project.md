...
The NuGet package can be found in the instalation directory of the IgniteUI product under MVC\MVC6\Bin\dotnetcore1.0.
...
From the options window add a new package source and change the source path to point to the nuget package in the instalation directory. The result should look similar to the following screenshot.
